    ...
    <section class="checkout-wrapper section">
        <div class="container">
            <div class="row justify-content-center">
                <form action="{{ route('checkout') }}" method="POST" class="col-lg-8">
                    @csrf
                                ...
                                <section class="checkout-steps-form-content collapse show" id="collapseThree"
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="single-form form-default">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 form-input form">
                                                        <x-form.input type="text" name="addr[billing][first_name]"
                                        ...
                                        <div class="col-md-6">
                                            <div class="single-form form-default">
                                                <label>Country</label>
                                                <div class="form select-items">
                                                    <x-form.select type="text" name="addr[billing][country]"
                                                        placeholder="Country" :options="$countries"
                                                        head_option="Select Country" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="single-form form-default">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 form-input form">
                                                        <x-form.input type="text" name="addr[shipping][first_name]"
                                                            placeholder="First Name" />
                                                    </div>
                                                    <div class="col-md-6 form-input form">
                                                        <x-form.input type="text" name="addr[shipping][last_name]"
                                                            placeholder="Last Name" />
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="single-form form-default">
                                                <label>Post Code</label>
                                                <div class="form-input form">
                                                    <x-form.input type="text" name="addr[shipping][postal_code]"
                                                        placeholder="Post Code" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="single-form form-default">
                                                <label>Country</label>
                                                <div class="form select-items">
                                                    <x-form.select type="text" name="addr[shipping][country]"
                                                        placeholder="Country" :options="$countries"
                                                        head_option="Select Country" />
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="single-form button">
                                                <button type="button" class="btn" data-bs-toggle="collapse"
                                                    ...
                                                    aria-controls="collapsefive">next
                                                    step</button>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="checkout-sidebar">
                        <div class="checkout-sidebar-coupon">
                            ...
                            <form action="#">
                                <div class="single-form form-default">
                                    <div class="form-input form">
                                        <x-form.input type="text" name="coupon" placeholder="Coupon Code" />
                                    </div>
                                    <div class="button">
