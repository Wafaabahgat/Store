                ...
                <div class="col-lg-8 col-12 custom-padding-right">
                    <div class="slider-head">
                        ...
                        <div class="hero-slider">
                            ...
                            <!-- End Single Slider -->
                            <!-- Start Single Slider -->
                            <div class="single-slider" style="background-image: url(assets/images/hero/1.2.png);">

                            </div>
                            <!-- End Single Slider -->
                            <!-- Start Single Slider -->
                            <div class="single-slider" style="background-image: url(assets/images/hero/1.3.png);">
                ...
                <div class="col-lg-4 col-12">
                    <div class="row">
                        <div class="col-lg-12 col-md-6 col-12 md-custom-padding">
                            <!-- Start Small Banner -->
                            <div class="hero-small-banner" style="background-image: url('assets/images/hero/b1.png');">
                        ...
                        <div class="col-lg-12 col-md-6 col-12">
                            ...
                            <div class="hero-small-banner style2"
                                style="background-image: url('assets/images/hero/b2.png');">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="single-banner"
                        style="object-fit: contain;aspect-ratio:3.5/2 ;background-image:url('assets/images/hero/1.4.png')">
